...
plot(mesh)
plt.savefig("../Figures/mesh_with_hippocampus.png", bbox_inches='tight')
...
ufile_pvd = File("Stokes with hippocampus plots/velocity.pvd")
ufile_pvd << u
pfile_pvd = File("Stokes with hippocampus plots/pressure.pvd")
pfile_pvd << p

# Save velocity
with XDMFFile(MPI.comm_world, '../diffusion-convection/velocity_with_hippocampus.xdmf') as xdmf:
